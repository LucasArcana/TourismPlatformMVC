    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        AgencyProfileID = c.Int(nullable: false, identity: true),
                        AgencyName = c.String(),
                        Desc = c.String(),
                        ContEmail = c.String(),
                        PhoneNo = c.String(),
                ...
                .PrimaryKey(t => t.AgencyProfileID);
            ...
            CreateTable(
                ...
                c => new
                    {
                        TourScheduleId = c.Int(nullable: false, identity: true),
                    })
                .PrimaryKey(t => t.TourScheduleId);
